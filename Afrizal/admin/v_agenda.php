				...
				<?php
					$no=0;
  					foreach ($data->result_array() as $i) :
                       ...
                       $agenda_tanggal=$i['agenda_tanggal'];
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Waktu</label>
                                <div class="col-sm-7">
                                    <input type="text" name="xwaktu" class="form-control" value="<?php echo $agenda_tanggal;?>" id="inputUserName" placeholder="Contoh: 10.30-11.00 WIB" required>
                                </div>
                            </div>
