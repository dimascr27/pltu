      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'admin/tulisan/add_tulisan'?>"><i class="fa fa-thumb-tack"></i> Post Activity</a></li>
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
              ...
              <input type="text" name="xjudul" class="form-control" value="<?php echo $b['tulisan_judul'];?>" placeholder="Judul Activity atau artikel" required/>
            </div>
            <!-- /.col -->
            <div class="col-md-2">
